...
public class WeBElementActions {
    ...
    /*Click on element */
    public void clickingElement(String selector, Locators l, ExpectedConditionsEnum ConditionOnCurrentPage) {
    ...
    /*Send keys*/
    public void sendKeysElement(String selector, Locators l, ExpectedConditionsEnum ConditionOnCurrentPage, String Keys) {
    ...
    public void ScrollWithJS(String selector, Locators L) throws InterruptedException {
        ...
        js.executeScript("arguments[0].scrollIntoView();", waitUntilCanValidate(returnElementLocatorBy(selector, L), ExpectedConditionsEnum.presenceOfElement));
